...
#endif
            {
                ...
                while (restart)
                {
                    ...
                    if (nodeModeNumber == 1)
                    {
                        ...
                        bool lowpriority = commandLineSwitches[CommandLineSwitches.ParameterizedSwitch.LowPriority].Length > 0 ? commandLineSwitches[CommandLineSwitches.ParameterizedSwitch.LowPriority][0].Equals("true") : false;
